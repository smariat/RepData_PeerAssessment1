...
**Coursera Reproducable Research Peer Assignment #1.**

###Loading & Preprocessing Data

---

To begin, remove all variables from the environment
```{r setup}
...
Then, download the dataset required, described as follows: 
